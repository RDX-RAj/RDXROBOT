...
def Mukesh_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "mukesh_":
        ...
        query.message.edit_caption(f"*๏ *ɪ ᴀᴍ {dispatcher.bot.first_name}*"
            ...
            f"\n*๏ ᴜsᴇʀs ➛* {sql.num_users()}"
            f"\n*๏ ᴄʜᴀᴛs ➛* {sql.num_chats()}"
            f"\n\n*๏ ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴜᴛᴛᴏɴs ʙᴇʟᴏᴡ ғᴏʀ ɢᴇᴛᴛɪɴɢ ʜᴇʟᴘ ᴀɴᴅ ɪɴғᴏ ᴀʙᴏᴜᴛ {dispatcher.bot.first_name}.*",
            parse_mode=ParseMode.MARKDOWN,
...
ꜱᴇᴛ ᴀ ᴡᴇʟᴄᴏᴍᴇ ᴍᴇꜱꜱᴀɢᴇ!""",parse_mode=ParseMode.MARKDOWN,
        ...
        InlineKeyboardButton(text="🖥️", callback_data="Main_help"),
                    ...
                    [
                        InlineKeyboardButton(text="Dᴏɴᴀᴛᴇ", url="https://t.me/roy_editx"),InlineKeyboardButton(text="• sᴜᴘᴘᴏʀᴛ •", callback_data="mukesh_support")
                    ]
                ]
            ),
            )  

...
from Mukesh Robot.modules.disable import DisableAbleCommandHandler
from Mukesh Robot.modules.helper_funcs.alternate import typing_action
...
def weebify(update, context):
    ...
    if not string:
        message.reply_text("ᴜꜱᴀɢᴇ ɪꜱ `/weebify <text>` ʙᴀʙʏ🥀", parse_mode=ParseMode.MARKDOWN)
        return
...
def bubble(update, context):
    ...
    if not string:
        message.reply_text("ᴜꜱᴀɢᴇ ɪꜱ `/bubble <text>` ʙᴀʙʏ🥀", parse_mode=ParseMode.MARKDOWN)
        return
...
def fbubble(update, context):
    ...
    if not string:
        message.reply_text("ᴜꜱᴀɢᴇ ɪꜱ `/fbubble <text>` ʙᴀʙʏ🥀", parse_mode=ParseMode.MARKDOWN)
        return
...
def square(update, context):
    ...
    if not string:
        message.reply_text("ᴜꜱᴀɢᴇ ɪꜱ `/square <text>` ʙᴀʙʏ🥀", parse_mode=ParseMode.MARKDOWN)
        return
...
def fsquare(update, context):
    ...
    if not string:
        message.reply_text("ᴜꜱᴀɢᴇ ɪꜱ `/fsquare <text>` ʙᴀʙʏ🥀", parse_mode=ParseMode.MARKDOWN)
        return
...
def blue(update, context):
    ...
    if not string:
        message.reply_text("ᴜꜱᴀɢᴇ ɪꜱ `/blue <text>` ʙᴀʙʏ🥀", parse_mode=ParseMode.MARKDOWN)
        return
...
def latin(update, context):
    ...
    if not string:
        message.reply_text("ᴜꜱᴀɢᴇ ɪꜱ `/latin <text>`", parse_mode=ParseMode.MARKDOWN)
        return
...
def lined(update, context):
    ...
    if not string:
        message.reply_text("ᴜꜱᴀɢᴇ ɪꜱ `/lined <text>`", parse_mode=ParseMode.MARKDOWN)
        return
...
» `/weebify` <text>: ᴡᴇᴇʙɪꜰʏ ʏᴏᴜʀ ᴛᴇxᴛ!
» `/bubble` <text>: ʙᴜʙʙʟᴇ ʏᴏᴜʀ ᴛᴇxᴛ!
» `/fbubble` <text>: ʙᴜʙʙʟᴇ-ꜰɪʟʟᴇᴅ ʏᴏᴜʀ ᴛᴇxᴛ!
» `/square` <text>: ꜱQᴜᴀʀᴇ ʏᴏᴜʀ ᴛᴇxᴛ!
» `/fsquare` <text>: ꜱQᴜᴀʀᴇ-ꜰɪʟʟᴇᴅ ʏᴏᴜʀ ᴛᴇxᴛ!
» `/blue` <text>: ʙʟᴜɪꜰʏ ʏᴏᴜʀ ᴛᴇxᴛ!
» `/latin` <text>: ʟᴀᴛɪɴɪꜰʏ ʏᴏᴜʀ ᴛᴇxᴛ!
» `/lined` <text>: ʟɪɴᴇᴅ ʏᴏᴜʀ ᴛᴇxᴛ!

        ...
        try:
            ...
            if id.strip() == "":
                ...
                try:
                    id = int(id)
                    if id <= 0:
                        await event.edit("<code>ɪᴅ ɴᴜᴍʙᴇʀ ʏᴏᴜ ᴇɴᴛᴇʀᴇᴅ ɪꜱ ɪɴᴠᴀʟɪᴅ ʙᴀʙʏ🥀</code>")
                        return
                except:
                    await event.edit("<code>ɪᴅ ɴᴜᴍʙᴇʀ ʏᴏᴜ ᴇɴᴛᴇʀᴇᴅ ɪꜱ ɪɴᴠᴀʟɪᴅ ʙᴀʙʏ🥀</code>")
                    return
                if int(id) <= (len(photos)):
                    ...
                    await event.edit("<code>ɴᴏ ᴘʜᴏᴛᴏ ꜰᴏᴜɴᴅ ᴡɪᴛʜ ᴛʜᴀᴛ ɪᴅ ʙᴀʙʏ🥀</code>")
                    return
        except:
            await borg.send_message("ʀᴇᴘʟʏ ᴛᴏ ᴜꜱᴇʀ ᴍᴀᴛᴇ ʙᴀʙʏ🥀")

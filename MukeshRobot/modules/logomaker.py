...
__help__ = """
 » `/logo` <text> :  ᴄʀᴇᴀᴛᴇ ʏᴏᴜʀ ʟᴏɢᴏ ᴡɪᴛʜ ʏᴏᴜʀ ɴᴀᴍᴇ ᴡɪᴛʜ ᴍᴜʟᴛɪᴘʟᴇ ʙᴀᴄᴋɢʀᴏᴜɴɢ 
 » `/ylogo` <text> :  ᴄʀᴇᴀᴛᴇ ʏᴏᴜʀ ʟᴏɢᴏ ᴡɪᴛʜ ʏᴏᴜʀ ɴᴀᴍᴇ ɪɴ ʏᴇʟʟᴏᴡ ᴄᴏʟᴏᴜʀ 
 » `/vlogo` <text> :  ᴄʀᴇᴀᴛᴇ ʏᴏᴜʀ ʟᴏɢᴏ ᴡɪᴛʜ ʏᴏᴜʀ ɴᴀᴍᴇ ɪɴ ᴅᴀʀᴋᴍᴀɢᴇɴᴛᴀ ᴄᴏʟᴏᴜʀ 
 » `/wlogo` <text> :  ᴄʀᴇᴀᴛᴇ ʏᴏᴜʀ ʟᴏɢᴏ ᴡɪᴛʜ ʏᴏᴜʀ ɴᴀᴍᴇ ɪɴ ᴡʜɪᴛᴇ ᴄᴏʟᴏᴜʀ 
 » `/blogo` <text> :  ᴄʀᴇᴀᴛᴇ ʏᴏᴜʀ ʟᴏɢᴏ ᴡɪᴛʜ ʏᴏᴜʀ ɴᴀᴍᴇ ɪɴ ʙʟᴜᴇ ᴄᴏʟᴏᴜʀ 
 » `/rlogo` <text> :  ᴄʀᴇᴀᴛᴇ ʏᴏᴜʀ ʟᴏɢᴏ ᴡɪᴛʜ ʏᴏᴜʀ ɴᴀᴍᴇ ɪɴ ʀᴇᴅ ᴄᴏʟᴏᴜʀ 
 » `/alogo` <text> :  ᴄʀᴇᴀᴛᴇ ʏᴏᴜʀ ʟᴏɢᴏ ᴡɪᴛʜ ʏᴏᴜʀ ɴᴀᴍᴇ ɪɴ ᴀQᴜᴀ ᴄᴏʟᴏᴜʀ 
 » `/glogo` <text> :  ᴄʀᴇᴀᴛᴇ ʏᴏᴜʀ ʟᴏɢᴏ ᴡɪᴛʜ ʏᴏᴜʀ ɴᴀᴍᴇ ɪɴ ɢʀᴇᴇɴ ᴄᴏʟᴏᴜʀ 
"""

...
buttons = [
    ...
    [
        InlineKeyboardButton(text="ʜєʟᴘ ᴄᴏᴍᴍᴀɴᴅs", callback_data="Main_help"),
    ],
...
def Rdx_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "rdx_":
        ...
        [
            ...
            InlineKeyboardButton(text="˹ɪɴsᴛᴀ˼", url="https://www.instagram.com/vdjrajofficial?igsh=ZDExYjZkNGI0OA=="),

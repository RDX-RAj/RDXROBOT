...
if ENV:
    ...
    from RDXROBOT.config import Development as Config
...
telethn = TelegramClient("rdx", API_ID, API_HASH)

pbot = Client("RDXROBOT", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN,in_memory=True)
...
from RDXROBOT.modules.helper_funcs.handlers import (

...
@rdx.on_message(filters.command(["gps"]))
...
#     await message.delete()
    ...
    try:
        ...
        """
        geolocator = Nominatim(user_agent="ll_RJ29RDX_ll")
#         zoom=[0-18]
...
@rdx.on_message(filters.command(["distance"]))
...
# rdx.add_handler(MessageHandler(gps))     
# rdx.add_handler(MessageHandler(distance))
